...
def fallback_local_search(user_text):
    ...
    keywords = {
        ...
        "компания": ["компания", "о нас", "кто вы", "центр красок", "магазин", "занимается", "чем занимаетесь"],
        "контакты": ["телефон", "адрес", "где", "находит", "контакт", "астана", "алматы", "связь"],
        "товары": ["товары", "краски", "лаки", "ассортимент", "инструменты", "штукатурки"],
        "бренды": ["бренды", "бренд", "сотрудничает", "производители", "марки"]
    }
